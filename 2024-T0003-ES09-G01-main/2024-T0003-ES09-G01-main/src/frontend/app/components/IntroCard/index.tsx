...
const IntroCard = () => {
  return (
    <div className={styles.card}>
      ...
      <p>
        Se preferir, faça o{" "}
        <a href="data:text/csv;charset=utf-8,name,email,phone,CPF,Empresa,Company%0Aname%201,email%201,phone%201,CPF%201,Empresa%201,Company%201%0Aname%202,email%202,phone%202,CPF%202,Empresa%202,Company%202%0Aname%203,email%203,phone%203,CPF%203,Empresa%203,Company%203">
